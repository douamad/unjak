...
class MigrationCartalystSentinel extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('prenom');
            $table->string('nom');
            $table->enum('civilite',['m','mme','mlle','dr','me','pr','mgr'])->nullable();
            $table->integer('nationalite')->nullable();
            $table->string('adresse')->nullable();
            $table->string('telephone')->nullable();
            $table->string('autre_numero')->nullable();
            $table->string('skype')->nullable();
            $table->enum('situation',['eleve','etudiant','professionel','diplome','retraite','secret'])->nullable();
            ...
            $table->string('contact_prefere')->nullable();
            $table->timestamps();
