<header class="header">
    <div class="container">
        <div class="logo pull-left">
            <a href="index.html">
                <img src="{{ asset('img/unjak-logo2.jpg') }}" alt="Logo {{ $community->nom }}" style="width: 250px; height: 75px;"/>
            </a>
        </div>
        <div class="header-right-info pull-right clearfix">
            ...
            <div class="single-header-info">
                ...
                <div class="content">
                    <h3>Call Now</h3>
                    <p><b>({{ $community->indicatif }}) {{ $community->tel }}</b></p>
                </div>
            </div>
            <div class="single-header-info">
                                ...
                                <div class="donation-form-outer">
                                    <form action="contact.html" method="post">
                                        ...
                                        <div class="form-portlet">
                                            ...
                                            <div class="payment-option-logo"><img alt="payment/logo" src="" class="img-responsive"></div>
                                            <br>
                                        </div>
